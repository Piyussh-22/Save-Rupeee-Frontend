...
import { updateTransaction } from "./transactionSlice.js";
  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        <button
          onClick={onClose}
          className="flex-1 bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-medium py-2.5 rounded-xl cursor-pointer"
        >
          Cancel
        </button>
        <button
          ...
          disabled={loading}
          className="flex-1 bg-zinc-800 dark:bg-white text-white dark:text-zinc-900 font-medium py-2.5 rounded-xl cursor-pointer disabled:opacity-50"
        >
